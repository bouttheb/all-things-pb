  ...
  return (
    <button onClick={onClick} className="flex flex-col items-center gap-2 shrink-0 group">
      <div className="story-ring">
        <div className="w-16 h-16 rounded-full overflow-hidden bg-[var(--color-surface)] border-2 border-[var(--color-navy)]">
          {thumbnail ? (
            <img
              src={thumbnail}
              alt="Story"
            ...
            <div className="w-full h-full flex items-center justify-center bg-[var(--color-surface-elevated)]">
              <svg width={18} height={18} viewBox="0 0 24 24" fill="none" stroke="var(--color-slate)" strokeWidth={1.5}>
      ...
      <span
        className="text-[9px] uppercase tracking-[0.1em] text-[var(--color-slate)] group-hover:text-[var(--color-bone)] transition-colors"
